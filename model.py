...
def plot_absolute_values(result):
    ...
    # Variables without 'm'
    fig1 = go.Figure()
    fig1.add_trace(go.Scatter(x=t, y=Sd, mode='lines', name='Sd'))
    fig1.add_trace(go.Scatter(x=t, y=Sn, mode='lines', name='Sn'))
    fig1.add_trace(go.Scatter(x=t, y=S1, mode='lines', name='S1'))
    fig1.add_trace(go.Scatter(x=t, y=S2, mode='lines', name='S2'))
    fig1.add_trace(go.Scatter(x=t, y=V, mode='lines', name='V'))
    fig1.add_trace(go.Scatter(x=t, y=Id, mode='lines', name='Id'))
    fig1.add_trace(go.Scatter(x=t, y=In, mode='lines', name='In'))
    fig1.add_trace(go.Scatter(x=t, y=I1, mode='lines', name='I1'))
    fig1.add_trace(go.Scatter(x=t, y=I2, mode='lines', name='I2'))
    fig1.add_trace(go.Scatter(x=t, y=Rd, mode='lines', name='Rd'))
    fig1.add_trace(go.Scatter(x=t, y=Rn, mode='lines', name='Rn'))
    fig1.update_layout(title='VAP-SIRS Model Simulation for normal people', xaxis_title='Time (days)', yaxis_title='Population')

    # Variables with 'm'
    fig2 = go.Figure()
    fig2.add_trace(go.Scatter(x=t, y=Smn, mode='lines', name='Smn'))
    fig2.add_trace(go.Scatter(x=t, y=Smd, mode='lines', name='Smd'))
    fig2.add_trace(go.Scatter(x=t, y=Sm1, mode='lines', name='Sm1'))
    fig2.add_trace(go.Scatter(x=t, y=Sm2, mode='lines', name='Sm2'))
    fig2.add_trace(go.Scatter(x=t, y=Vm, mode='lines', name='Vm'))
    fig2.add_trace(go.Scatter(x=t, y=Imn, mode='lines', name='Imn'))
    fig2.add_trace(go.Scatter(x=t, y=Imd, mode='lines', name='Imd'))
    fig2.add_trace(go.Scatter(x=t, y=Im1, mode='lines', name='Im1'))
    fig2.add_trace(go.Scatter(x=t, y=Im2, mode='lines', name='Im2'))
    fig2.add_trace(go.Scatter(x=t, y=Rmn, mode='lines', name='Rmn'))
    fig2.add_trace(go.Scatter(x=t, y=Rmd, mode='lines', name='Rmd'))
    fig2.update_layout(title='VAP-SIRS Model Simulation for more susceptible people', xaxis_title='Time (days)', yaxis_title='Population')
